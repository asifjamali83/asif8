...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EG9PrJRcNpMFaUzjBnkb.iEKLQqr+KXdSVGWpsvd/QW.8XLywbqgg57gPRgN3g66V0KNdoMA814pNwNSnyPcS6o=')
nadya.loginResult()
...
╚═══════════════════
"""
tanjea="ufdc20b3a00b5e8f31e4f91017eb361b0"
...
Bots=[mid]
Creator=["u21e925a9047f9310ecbe0c0f4950feab"]
...
#                            Name = summon(op.param2)
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to,"Khusus Dhenza")
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to,"Khusus Nadya")
                ...
                wait["Sider"] = True
                nadya.sendText(msg.to,"Siap On Cari tikungan")
                
            elif "Sider off" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    nadya.sendText(msg.to, "Sepii bos gd yg bisa di tikung")
                else:
		...
		if midd not in admin:
		    ...
		    nadya.sendText(msg.to,"Admin Detected")
                ...
                midd = "u722fa0d22435d1fed3cf3d4c28373baa"
                nadya.inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in admin:
		    ...
		    if msg.from_ in Creator:
                     if msg.toType == 2:
                        ...
                        gs = nadya.getGroup(msg.to)
                        nadya.sendText(msg.to,"Tes sinyal rata gak rata penting hajar..Dadaaah~")
                        targets = []
                        for g in gs.members:
...
#			    nadya.inviteIntoGroup(msg.to, targets)
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["https://m.facebook.com/photo.php?fbid=913849988796571&id=100005147350992&set=a.109340595914185.12417.100005147350992&source=11"]
		...
		if msg.from_ in Creator:
                ...
                url = 'https://m.facebook.com/photo.php?fbid=934729876708582&id=100005147350992&set=a.119043878277190.20140.100005147350992&source=48' + search
